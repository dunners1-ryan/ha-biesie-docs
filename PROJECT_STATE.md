...
|---|---|---|
| 🛡️ Security | Working | Trust chain fixed. Inside cameras arming implemented. Triple-fire FIXED 2026-04-16: all three intruder automations now trigger on binary_sensor.security_intruder_active (from: off → on) with zone conditions. |
